...
function readPaper() {
  if (readPstate >= 7) {
    document.getElementById("slideEnd").style.visibility = "visible"
  ...
  "เค้าคงให้อะไรเธอมากไม่ได้เท่าไหร่หรอก ทำได้แค่นี้แหละ ขอให้เธอมีความสุขหลังจากนี้ ให้มากๆเลยนะ",
